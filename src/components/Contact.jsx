	...
	return (
		<div className="Contact">
			<div className="w-full flex flex-col items-center text-center sm:items-start sm:text-start">
				...
				<h4 className="pb-8">If you wish to contact me, I will be happy to receive your messages. You can contact me using the contact information provided. I hope to have the opportunity to speak with you soon.</h4>
			</div>
